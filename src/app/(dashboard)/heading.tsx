        ...
        <div>
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex gap-3 mt-4 mb-1">
                    <button onClick={()=>router.push("/projects")} className="flex gap-2 bg-white border rounded-full text-sm p-1 px-3  duration-500 hover:bg-[#e7dbff] hover:border-[#8b3dff]"> <IoFolderOpenOutline className="mt-[2px]"/> Your design</button>
