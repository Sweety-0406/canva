...
//     const [filterdData, setFilteredData] = useState<projectType[]>([])
//     // const {templateName} = useGetTemplateModal()
...
//     // const filteredDataClick = (templateName: string)=>{
...
//             {filterdData?.map((template: projectType) => (
//               <TemplateCard
//                 key={template.id}
//                 title={template.name}
